...
<form method="post" action="form_process.php">
  ...
  <input type="text" id="Header" class="header" name="Header4"><br>
  

  <label for="Date">Date :</label><br>
  <input type="text" id="Date" class="date" name="Date4"><br>
  

  <label for="Paragraph">Paragraph :</label><br>
  <textarea name="Paragraph4" id="Paragraph" class="para"></textarea><br>
